...
class Seminar extends CI_Controller
{
   ...
   if (!$this->ion_auth->logged_in()) {
    ...
    public function add()
    {
         ...
         * @return	void
         */
        $lnama_seminar = form_label('Nama Event', 'nama_seminar');
        /**
         * $ltgl_pelaksana.
         *
         ...
         * @return	void
         */
        $ltgl_pelaksanaan = form_label('Tanggal Pelaksanaan', 'tgl_laksana');
        /**
         * $lharga_tiket.
         *
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('nama_seminar', 'Nama Event', 'trim|required', $attr_namasemiar);
