...
class Mahasiswa extends CI_Controller
{
   ...
   if (!$this->ion_auth->logged_in()) {
    ...
    public function add()
    {
         ...
         * @return	void
         */
        $lprodi = form_label('Perusahaan', 'prodi');
        /**
         * $lkonsentrasi.
         * label konsentrasi 
         ...
         * @return	void
         */
        $lkonsentrasi = form_label('Divisi', 'konsentrasi');
        /**
         * $ljenjang.
         *
         ...
         * @return	void
         */
        $ljenjang = form_label('Jabatan', 'jenjang');
        /**
         * $lemail.
         *
         * @param	string	'email'	
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('nim', 'NIM', 'trim|required|numeric|min_length[14]|max_length[14]', $attrnim);
