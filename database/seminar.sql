...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2022 at 09:05 AM
...
(1, '05602110001002', 'John Doe', 1, 1, 1, 'johndoe@gmail.com', '123456789');
...
(7, 'John Speaker', 'Business Owner', 1, 'e016613d46582f4549a223cbe7510426.jpg'),
(10, 'Johny Doe', 'Associate Mobile Android Developer', 1, 'e249aecd48001b80e4fb71bd644a6624.jpg'),
(11, 'Asep', 'Area Sales Coordinator The Doe Company', 1, 'bfa268a60f5d6674fb41710ff1a74821.jpg');
...
CREATE TABLE `presensi_seminar` (
  ...
  `nomor_induk` varchar(14) NOT NULL,
  `id_seminar` tinyint(3) NOT NULL,
...
(88, 1, '05602110001002', 1, '2022-03-15', '05:11:19', 2);
...
(1, '127.0.0.1', 'administrator', '$2y$12$ml83HGMMj9/8lQ9yTVmhrO/jIQiGPEwvn0cIXYRP2W3fIaUHeo7G.', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1647339001, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
ALTER TABLE `presensi_seminar`
  MODIFY `id_presensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
